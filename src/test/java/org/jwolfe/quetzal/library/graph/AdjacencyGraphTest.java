...
class AdjacencyGraphTest {
    ...
    @Test
    void countNumberOfPathsBetweenVertices() {
        AdjacencyGraph graph;
        ...
        graph.addEdge(2, 1);
        graph.addEdge(1, 3);
        assertEquals(3, graph.countNumberOfPathsBetweenVertices(2, 3));
        ...
        graph.addEdge(2, 4);
        graph.addEdge(3, 2);
        assertEquals(4, graph.countNumberOfPathsBetweenVertices(0, 4));
    }
}